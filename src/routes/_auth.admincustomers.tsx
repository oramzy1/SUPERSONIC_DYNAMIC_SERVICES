      ...
      <div className="bg-[#0d111a]/40 backdrop-blur-md border border-white/6 rounded-xl overflow-hidden flex flex-col mb-6">
            ...
            <tbody className="divide-y divide-white/2">
              {customerRecords.map((row, idx) => (
                <tr key={idx} className="hover:bg-white/2 transition duration-150">
                  ...
                  <td className="py-4 px-6 text-xs font-medium text-slate-400">{row.lastActive}</td>
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-white/6 bg-white/1">
          <span className="text-xs text-slate-500 font-medium">
            Showing <span className="text-slate-400 font-semibold">1 to 10</span> of{" "}
            <span className="text-slate-400 font-semibold">1,248</span> entries
          </span>
          ...
          <div className="flex items-center gap-1">
            ...
            <button className="p-1.5 rounded-md border border-white/6 text-slate-400 hover:text-slate-200 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
        <div className="bg-[#0d111a]/40 backdrop-blur-md border border-white/6 rounded-xl p-4 flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[11px] text-slate-500 mt-0.5">
              Top 3 Corporate accounts expanded operational volume by 14% this week.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#0d111a]/40 backdrop-blur-md border border-white/6 rounded-xl p-4 flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[11px] text-slate-500 mt-0.5">
              18 individual accounts are pending business credential matching verification.
            </p>
          </div>
        </div>
      </div>
