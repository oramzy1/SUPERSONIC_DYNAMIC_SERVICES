    ...
    <div className="w-full text-slate-200 select-none pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
        {summaryMetrics.map((card, idx) => {
          ...
          return (
            <div
              key={idx}
              className="bg-[#0d111a]/40 backdrop-blur-md border border-white/6 rounded-xl p-5 flex flex-col justify-between h-36 relative"
            >
              <div className="flex items-start justify-between w-full">
                ...
                <div
                  className={`p-1.5 bg-white/2 rounded-lg border border-white/6 ${card.isAlert ? "text-rose-400" : "text-[#E2A54A]"}`}
                >
      ...
      <div className="flex flex-col gap-4 mb-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center bg-[#0d111a]/40 backdrop-blur-md p-1 rounded-lg border border-white/6 text-[11px] font-medium">
            <button className="flex items-center gap-1 px-3 py-1 bg-white/5 text-white rounded-md border border-white/6 font-semibold shadow-sm">
              <LayoutList className="w-3.5 h-3.5 text-[#E2A54A]" /> List
            </button>
            <button className="flex items-center gap-1 px-3 py-1 text-slate-500 hover:text-slate-300 transition-colors">
