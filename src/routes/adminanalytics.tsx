...
export const Route = createFileRoute("/adminanalytics")({
...
export function AnalyticsDashboard() {
  ...
  return (
    <div className="flex h-screen w-full bg-[#07090e] text-[#626d7c] font-sans antialiased overflow-hidden">
      {/* Injected Keyframes for SVG Dash-Array Line Pull, Horizontal Progress, and Metric Value Pops */}
      <style>{`
        @keyframes drawLine {
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full relative">
        ...
        {/* CONTAINER VIEWPORT */}
        <div className="flex-1 overflow-y-auto p-8 space-y-6 h-[calc(100vh-64px)]">
          {/* TOP CONTEXT BAR */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-3 self-start sm:self-center">
              ...
              <button className="flex items-center gap-1.5 bg-[#e2a54a] hover:bg-[#cb923c] text-[#07090e] font-bold text-[11px] tracking-wide px-3 py-1.5 rounded transition-all uppercase">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div className="xl:col-span-2 bg-[#0c1017] border border-[#161b22] rounded-xl p-6 flex flex-col justify-between relative">
              ...
              <div className="w-full h-48 mt-6 relative">
                <svg className="w-full h-full" viewBox="0 0 580 180" preserveAspectRatio="none">
                  {/* Horizontal Grid Guidelines matching reference image precisely */}
                  ...
                  {/* Gradient-Filled Area Spline Component with custom reveal animation */}
                  <path
                  ...
                  {/* Master SVG Stroked Vector Path Line with active dynamic drawing properties */}
                  <path
            ...
            <div className="bg-[#0c1017] border border-[#161b22] rounded-xl p-6 flex flex-col justify-between">
              <div className="flex items-start justify-between">
                <div>
              ...
              {/* Horizontal Funnel Segment Stack with delayed transition loading logic */}
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div className="bg-[#0c1017] border border-[#161b22] rounded-xl p-6">
          ...
          <div className="bg-[#0c1017] border border-[#161b22] rounded-xl p-5 flex flex-col md:flex-row items-center justify-between gap-4">
